...
:camera: Redux 用来管理状态，但在状态管理的背后，还有一些隐藏的能力 ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: 简单方式: 每个组件各自获取自己所需要的数据 ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: Redux 将数据集中地存储起来 ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: 从根组件获取数据 ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: 通过 props 将数据传递给目标组件 ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: 使用 Redux 将数据直接提取至目标组件 ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: 将复杂逻辑拆分成 reducer ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: Redux 的威力远不止状态管理 ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: 撤消、重做 ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: Google Docs ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: Optimistic UI ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: Twitter 点赞 ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: 保存/加载游戏进度 ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: 终端应用 Hyper 中的 “wow” 模式 ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: 在 Redux 开发者工具进行时间旅行 ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: 自动反馈 Bug ([Beebee](https://beebeeye.github.io/) 作图)
...
:camera: Redux 可以搭配其他前端框架一起使用 ([Beebee](https://beebeeye.github.io/) 作图)
